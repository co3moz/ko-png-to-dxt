...
module.exports = function bufferPng2Dxt(buffer, opts) {
  return new Promise((resolve, reject) => {
    ...
    png.parse(buffer, err => {
      ...
      try {
        let imageData;
        let formatData;
        let format = opts && opts.format ? opts.format : 'a8r8g8b8';
        ...
        let name = 'png2dxt;' + Date.now() + ';online_service' + (opts && opts.name ? ';' + opts.name : '');
